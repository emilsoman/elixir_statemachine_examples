defmodule SecretQuestion do
  ...
  def start(data = {question, expected_answer} \\ {"Hello?", "world"})
    when is_binary(question) and is_binary(expected_answer) do
  ...
  def handle_event({:call, from}, :get_question, :locked, {question, _}) do
  ...
  def handle_event({:call, from}, {:unlock, answer}, :locked, {_question, answer}) do
    ref = make_ref
  ...
  def handle_event(:cast, {:lock, ref, data = {question, answer}}, :unlocked, ref)
